    ...
    public static partial class HairSim
    {
        public struct SolverData
        {
            ...
            public struct SolverBuffers<T>
            {
                ...
                public T _PinGlobals;					// float4[1]: x=pullMul, y=chainMul, z=bindTh, w=releaseTh
                public T _ParticleChainBind0;			// float4[particleCount]: xyz=localOffset, w=packed(segIdx|activeBit)
                public T _ParticleChainBind1;           // float4[particleCount]: x=tOnSegment, yzw unused
